...
namespace DontTowMeBro
{
    ...
    public partial class PZStartPage : PhoneApplicationPage
    {
        ...
        private pzStartTimePacket t = new pzStartTimePacket();
        int hour, min, sec;
        ...
        public PZStartPage()
        {
            ...
            pzLBStartH.ItemsSource = pzTimeView.startTimeHList;
            pzLBStartM.ItemsSource = pzTimeView.startTimeMList;
            pzLBStartS.ItemsSource = pzTimeView.startTimeSList;
        ...
        /// <summary>
        /// Done button
        /// ToDo: Will send completion state info back to main
        /// </summary>
        ...
        {
            newSettingsState.StartTimePacket = t;        
        ...
        /// <summary>
        /// Controls Start hour list highlight
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void pzLBStartH_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            try
            {
                GetItemsRecursive<UserControl>(pzLBStartH, ref listItems);
            }
            catch (Exception ex)
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void pzLBStartM_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            //Grab  Items
            List<UserControl> listItems = new List<UserControl>();
            ...
            try
            {
                GetItemsRecursive<UserControl>(pzLBStartM, ref listItems);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "GetItemsRecursive Error; PZStartPage.xaml.cs", MessageBoxButton.OK);
            ...
            try
            {
                ...
                if (s == Switch.SELECTED)
                {
                    ...
                    //}
                    //if(Convert.ToInt16(e.AddedItems[0].ToString()) > 9)
                    item.items = Convert.ToInt16(e.AddedItems[0].ToString());
                    listItemDataM.Clear();
